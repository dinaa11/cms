...
<html lang="en">
    ...
    <head>
        ...
        <!-- Nucleo Icons -->
        <link
            href="<?= base_url('assets/hay') ?>/assets/css/nucleo-icons.css"
            rel="stylesheet"/>
        <!-- CSS Files -->
        <link
            href="<?= base_url('assets/hay') ?>/assets/css/bootstrap.min.css"
            rel="stylesheet"/>
        <link
            href="<?= base_url('assets/hay') ?>/assets/css/black-dashboard.css?v=1.0.0"
            rel="stylesheet"/>
        <!-- CSS Just for demo purpose, don't include it in your project -->
        <link
            href="<?= base_url('assets/hay') ?>/assets/demo/demo.css"
            rel="stylesheet"/>
        <script
    ...
    <div class=" wrapper" >
        ...
        <script
            src="<?= base_url('assets/hay') ?>/assets/js/plugins/perfect-scrollbar.jquery.min.js"></script>
        <!-- Google Maps Plugin -->
        ...
        <script
            src="<?= base_url('assets/hay') ?>/assets/js/plugins/bootstrap-notify.js"></script>
        <!-- Control Center for Black Dashboard: parallax effects, scripts for the
        example pages etc -->
        <script
            src="<?= base_url('assets/hay') ?>/assets/js/black-dashboard.min.js?v=1.0.0"

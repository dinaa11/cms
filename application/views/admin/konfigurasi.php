            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <form action="<?= base_url('admin/konfigurasi/update') ?>" method="post">
                    ...
                    <div class="modal-content" style="background:#222A42; color:white;">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalCenterTitle" style="color:white;">Konfigurasi</h5>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col mb-6">
                                    <label for="nameWithTitle" class="form-label" style="color:white;">Judul Website</label>
                            ...
                            <div class="row">
                                <div class="col mb-6 mt-4">
                                    <label for="nameWithTitle" class="form-label" style="color:green;">Profile</label>
                            ...
                            <div class="row">
                                <div class="col mb-6 mt-4">
                                    <label for="nameWithTitle" class="form-label" style="color:white;">Facebook</label>
                                    <input type="text" id="nameWithTitle" class="form-control" name="facebook" value="<?= $konfig->facebook; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col mb-6 mt-4">
                                    <label for="nameWithTitle" class="form-label" style="color:white;">Instagram</label>
                                    <input type="text" id="nameWithTitle" class="form-control" name="instagram" value="<?= $konfig->instagram; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col mb-6 mt-4">
                                    <label for="nameWithTitle" class="form-label" style="color:white;">Email</label>
                                    <input type="text" id="nameWithTitle" class="form-control" name="email" value="<?= $konfig->email; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col mb-6 mt-4">
                                    <label for="nameWithTitle" class="form-label" style="color:white;">Alamat</label>
                                    <input type="text" id="nameWithTitle" class="form-control" name="alamat" value="<?= $konfig->alamat; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col mb-6 mt-4">
                                    <label for="nameWithTitle" class="form-label" style="color:white;">Whatsapp</label>
